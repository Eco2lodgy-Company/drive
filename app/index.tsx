...
const styles = StyleSheet.create({
  ...
  container: {
    flex: 1,
    justifyContent: "flex-end", // Tout le contenu est poussé vers le bas
    alignItems: "center",
    paddingVertical: 40,
  ...
  content: {
    alignItems: "center",
    marginBottom: 30, // Espace avant le slogan
  },
  title: {
    fontSize: 60,
    fontWeight: "900",
  ...
  subtitle: {
    ...
    color: "#ddd",
    textAlign: "center",
    marginVertical: 15, // Espacement entre titre et boutons
    maxWidth: 320,
    lineHeight: 28,
    fontWeight: "300",
  },
