...
const HomeScreen = () => {
  ...
  const products = [
    { id: '1', name: 'T-Shirt Black', price: 29.99, shop: 'Noor Boutique', image: 'https://via.placeholder.com/150' },
    { id: '2', name: 'Jeans Blue', price: 59.99, shop: 'Fashion Hub', image: 'https://via.placeholder.com/150' },
    { id: '3', name: 'Sneakers White', price: 89.99, shop: 'Trendy Wear', image: 'https://via.placeholder.com/150' },
    { id: '4', name: 'Jacket Leather', price: 129.99, shop: 'Noor Boutique', image: 'https://via.placeholder.com/150' },
    { id: '5', name: 'Cap Gray', price: 19.99, shop: 'Street Style', image: 'https://via.placeholder.com/150' },
    { id: '6', name: 'Hoodie Red', price: 49.99, shop: 'Fashion Hub', image: 'https://via.placeholder.com/150' },
  ];
